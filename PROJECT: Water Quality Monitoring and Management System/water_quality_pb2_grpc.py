...
class WaterControlCenterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetNeighbors = channel.unary_unary(
                '/waterquality.WaterControlCenter/GetNeighbors',
                request_serializer=water__quality__pb2.StationRequest.SerializeToString,
                response_deserializer=water__quality__pb2.NeighborList.FromString,
                _registered_method=True)
...
def add_WaterControlCenterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetNeighbors': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=water__quality__pb2.StationRequest.FromString,
                    response_serializer=water__quality__pb2.NeighborList.SerializeToString,
            ),
    }
...
class WaterControlCenter(object):
    ...
    def GetNeighbors(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/waterquality.WaterControlCenter/GetNeighbors',
            water__quality__pb2.StationRequest.SerializeToString,
            water__quality__pb2.NeighborList.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
